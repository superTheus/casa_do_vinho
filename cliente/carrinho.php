...
<body>
	<div class="container">
		...
		<?php if($resultsCarts) { ?>
				...
				<tbody>
				  <?php foreach($resultsCarts as $result) : ?>
					<tr>
						...
						<td><a  class="btn btn-danger" href="functions/compra.php?qtd=<?php echo $result['quantity']?>&nome=<?php echo $result['name']?>&st=<?php echo $result['subtotal']?>&id=<?php echo $result['id']?>&idUsu=<?php echo $id_usu?>" class="card-link">Finalizar compra</a></td>
			...
			<a class="btn btn-info" href="#" onclick="window.close()">Continuar Comprando</a>
			<button class="btn btn-primary" type="submit">Atualizar Carrinho</button>
			
			<a  class="btn btn-danger" href="javascript:fechar()" class="card-link">Fechar</a>
